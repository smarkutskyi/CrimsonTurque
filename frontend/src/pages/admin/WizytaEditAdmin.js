...
const WizytaEditAdmin = () => {
    ...
    const pobierz = async () => {
        ...
        try{
            const resMain = await fetch(`http://localhost:3001/crimsonTorque/wizyta/admin/${id}`, {
                method: "GET",
                credentials: "include",
            });
            ...
            setForm({
                mechanikId: dataMain.mechanikId,
...
export default WizytaEditAdmin;