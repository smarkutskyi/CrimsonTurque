...
const MechanikDodajAdmin = () => {
    ...
    const dodaj = async () => {
        ...
        try {
            ...
            const res = await fetch('http://localhost:3001/crimsonTorque/mechanik/admin/add', {
                method: 'POST',
                headers: {
...
export default MechanikDodajAdmin;